...
%-------------------------------------------------------------------------
\begin{abstract} 
\KR{need to redo this to be more in line with REF and to include two iterations}
This research investigates how communities can
...
For this, the research \sout{investigates the use of creative and narrative-based
approaches, given the potential for stories to illuminate} deploys creative and narrative or story-based approaches as means to illuminate \sout{investigates the use of creative and narrative-based
approaches, given the potential for stories to illuminate} different viewpoints
and interpretations of Cultural Heritage within the community. \MS{Here the twofold contribution was not clear and the word contribution was mentioned twice, hence I have changed that to reflect the two parts of contribution}
The contribution of the
paper is twofold
\sout{contribution is}, as it includes a novel approach for developing and re-telling communities' narratives
linked to people, objects, sites and events in the urban landscape; while also proposing a workflow to communicate these narratives through \emph{Augmented
...
proposed as a means to document and disseminate the narratives in a way \sout{which
can enhance} that enhances the public understanding and appreciation of objects and sites \sout{in
their} within communities. The approach was initially piloted with a class of 32 children in a local primary school in Brighton and Hove (UK) in order to understand its suitability
for community engagement, targeting young audiences. \MS{I have added more info on the second iteration} Currently, the project has been expanded to five more schools in the area with plans to expand it further \sout{has been tested with 32 children in local
...
demonstrates the potential of the synergy between creative and digital approaches \sout{of both creative and digital approaches} for
...
For instance, until now \sout{Until now}, communities have rarely had an input into which heritage to present or preserve.
\sout{Their participation} Participating in this process might provide new insights into which
heritage is important for their community. But most importantly, it will allow people to explore the benefits \sout{for people in} of engaging in \sout{this} such process, as well as \sout{including in} exploring their own identity. In this way, engagement with heritage \sout{might} has the potential to lead to \sout{benefits such as} improvements of people's well-being and resilience. 


Computer graphics technologies have an important role to play in \sout{this process} community engagement activities. They can be used to generate visually rich 3D environments for people to interact with and can underpin a high-level of creativity in the process of engaging with heritage. However, limited research has been done in this area.  The research presented in this paper aims to address this gap. Following our research presented in \cite{6b8314fd76a64d3f86fd627505cc29e9} \MS{this reference does not appear correctly}, this paper expands \sout{on our research} towards exploring how entry barriers can be lowered for a
wider set of audiences to \sout{connect} enhance the connections with their local heritage outside museum
settings. In particular, \sout{it} the paper expands the theoretical context in which the research is conceptualised, as well as presents alternative digitisation pipeline allowing to capture a wide variety of creative narrative forms based on non-image  and image based 3D modeling. 

In this research, the term \textit{place-based
narratives} is used to refer to the narratives linked to \sout{the}
people, objects, sites and events in the urban landscape as told by the
community. As such, the research acknowledges the important \MS{geographical is important as we discuss about place-based narratives. Could we add instead something like "spatiotemporal relationships"? It has a meaning that expands to place and time, which might be even more related to history and heritage} relationships
between a community and the geographical \MS{if we add the word spatiotemporal then geographical should be removed} areas in which they move on a daily basis, which
...
approaches for engaging with heritage \sout{of} through place. Given the potential for stories to illuminate different viewpoints regarding Cultural Heritage assets, this approach can easily be deployed with a variety of traditional and non-traditional museum audiences, such as young children, people with disabilities, people with mental health problems and others. The methodology for the research is based on an iterative \sout{research} process, in which we firstly explore and propose the conceptual approach for
the development of place-based narratives through community involvement; and
secondly \sout{by deploying} we deploy novel technologies and workflows to support this process, \MS{here I would add something to show that it is indeed an iterative process, such as: while re-examining concepts and technologies as they emerge from the creativity sessions and participants' narrative input.}

The technical contributions of the research include a workflow to digitise creative narrative forms produced during the \sout{narrative} engagement \sout{process} sessions, as well as digital experiences to communicate these narratives to a wider audience. Given the emphasis on place, we use \emph{Augmented Reality (AR)} Maps, which are physical printed
maps, such as a map of a geographical area or a building, with embedded
...
map. Interactions with the digital 3D scenes embedded in the map \sout{might} include
the ability to visualise and interact with the narratives of communities
recorded as a mixture of content including text, images and 3D \sout{content} objects. 
...
viewpoints; survive the lifespan of the physical element; and form a vivid, present depiction of heritage that can be deployed by future generations as well \MS{I have added this about future generations}. Moreover, the
printed element of the map can also serve as a physical memento of an experience, such as
...
multiple interpretative narratives \MS{I would add as it is very relevant to current situation " while representing different voices and embracing diversity in the heritage context"}.

The approach for creating and re-telling place-based narratives was piloted with a community of school children in the city of Brighton and Hove (UK) and then expanded to five more schools in the area. \MS{I added the iteration} The children firstly engaged through \sout{an artistic} a creative process to generate
place-based narratives of their daily journeys between home and school.
Thereafter, the narratives were converted into an AR Map that the children and their families could experience and share. \MS{added this about sharing experience}
...
\KR{add text in the proposal - both for AR expeiences, and also for place, narrative and identity}
...
formal education. \sout{In particular} For the pilot case, the research engaged with children between
the ages of 10-11 studying at a local primary school, in the year before they
move to secondary school. A second iteration of the project included more children from local schools in the final years of primary education. \MS{added this about second iteration}
...
During the design of the experience \MS{shall we better say of the "experiential framework"?}, the team aimed to understand how children
could engage with their cultural environment while \sout{addressing subjects in the} taking into account the 
curriculum, stimulating their creativity and addressing their well-being
needs. \sout{Particular} Attention was placed on identifying any particular issues
concerning the children who \sout{will be} were involved in the experience, including any
educational or well-being issues that might \sout{be experiencing} affect them at that point
in time. These issues are context dependent and are likely to be \sout{affected} influenced by
external factors including community cohesion, socio-economic situation and
pressures from friends and family.

Thereafter, an artist facilitated ten workshops at the \MS{added about pilot school} pilot school in order to
...
mediation of a digital device. We used crafted elements that represented 
the narratives regarding the journeys children undertake from home to school. 
In order to provide a starting point, we use the concept of \emph{home} as a
starting point and each child produced a decorated box
...
really paid attention to the fa\c{c}ade of their houses. 
...
Figure~\ref{fig:artwork}-left illustrates a mixture of the produced crafted materials
\sout{which was produced}. Children also produced drawings or collages using a
...
researched on \MS{added about historical events}. 
...
account in order to digitise the physical artwork using 3D technologies. Decisions were mostly driven by the fact that the process must be scalable to deal with large amount of crafted elements, and that the crafted material was going to be rendered as
augmented content on the map. Hence, important requirements were to design workflows that provided content from every child, produced high-quality content and that enable to produce good quality representations which enabled to keep high
framerates. This meant that the
box-houses and their content were prioritised for digitisation amongs other crafted elements.
Other crafted objects, 
such as those containing foliage, feathers and wire were deemed too challenging 
for their inclusion in the AR experience during the first iterations of the project.
...
We trailed two methods which produce suitable results for digitising this type of visual content. For both methods we used a mirrorless Sony a7R III with a Sigma 1:1.4 DG
...
provide diffuse lighting. This setup ensured that the process had some degree of automation while ensuring
high quality results.

Afterwards, we produced 3D models both by non-image 3D modelling and image based 3D modelling, also known as Structure from Motion (SfM). The latter process was deemed to be the most suitable for large-scale digitisation in such as way which maintains the visual quality of the narrative forms produced. These will be explained in the following subsections.
...
The textures for each box-house were created from images taken with the digital
camera. The number of photos required for each box-houses depended on its complexity. Some required only one image (of the fa\c{c}ade) with a simple
...
texture for each 3D model. This was done using a texture blueprint of each box-house and fitting cropped images from each side of the boxes. The resulting
...
animation simulates the box-house `roof' opening and closing in a similar way
which people can open and close the physical box. This takes advantage of the simplicity of the modelling approach and enable to create interesting effects during the AR experience.
...
experimented with a semi-automated image-based workflow. The main motivation for this is that it will allow us to process a wider variety of shapes without having to deal with modelling every customisation done to the crafted items. The main challenges which needed to be addressed was to ensure the visual quality of the items by capturing both the shape and the colour accurately. 


All box-houses were created from a similar cardboard box as a starting point, which were customised using paper of various colours and crayons. Although areas coloured using crayons displayed some shine when catching beams of light, most material was fairly non-reflective. We followed a similar process than \cite{Gaiani_2017} to ensure colour fidelity of the artefacts. This ensured that the 3D models which resulted from the process had a good and uniform quality in particular for the cardboard textures.


We made use of the X-Rite ColorChecker for the colour characterization process in the lighting environment in which we performed the digitisation process. The X-Rite ColorChecker automatically detects the colour checker and produces an ICC profile which is then applied to all images.


Thereafter, the workflow required of an operator taking a set of images using the
automated setup. For this, each box-house was placed on a turntable with a white background and photographed every $20\degree$ over three-full $360\degree$ rotations. For each rotation, the camera is rotated $90\degree$, generating in total between 54 - 60 images. We also made use of a measuring bar which uses circular cross-type targets. This allows to introduce scale to the 3D model when this is later processed.

The digital images were shot using ISO 100, and an aperture of F/11. The images were shot in RAW and later processed using the ICC profile before exporting them as a JPEG to be used during the image-based 3D modelling process. The sets of images are then automatically processed by a Python script which uses the Agisoft Metashape API 
\cite{Metashapesite}. This script reads the images from a folder, processes a 3D model, detect the targets captured in the image, scales and centres the model as shown in Figure \ref{fig:metashape}. All of this process is fully automatic.


\begin{figure}[ht] \centering
\includegraphics[width=1\linewidth]{images/metashape.png}
\caption{3D model of the box-house generated through a photogrammetry automated process} \label{fig:metashape} 
\end{figure}


Thereafter, a manual process is required to remove the excess geometry, including the measuring bar. Finally, the resulting 3D model is decimated to a size of 5,000 triangles and a texture with a reduced resolution. All content had to be post-processed in order to make it web-ready for the AR
...
% resolution of 96dpi.
For this, the glTF file format was used for encoding the 3D models and their animation
...
Ensuring and measuring colour fidelity of 3D models in an image-based 3D modelling process is still an open research matter. As such, we designed a method to evaluate the resulting colour fidelity of the 3D models being produced by the digitisation process. For this, we made the assumption that all areas of the 3D model which display a cardboard texture will have very similar colours.

Our method uses small patches (80 by 80 pixels) which are extracted from textures of two different 3D models, as shown in Figure \ref{fig:texturepatches}. We select areas that correspond to the non-decorated areas of the cardboard boxes as we assume these two areas must be similar in colour. 


We make use of the $\Delta$E (Delta E) measurement to understand the differences perceived between colours from the two different textures. $\Delta$EE is a metric for understanding how the human eye perceives colour difference, which was proposed by the International Commission on Illumination (CIE). On a typical scale, the Delta E value will range from 0 to 100. The difference of less than 1.0 between two colours means that the difference is not perceptible by human eyes. Any values above 11 indicate colours are more similar than opposite, while a value of 100 means that colours are exact opposite. We hypothesised that getting values between 1-10 meant the changes in texture colour will be perceptible only through close observation or at a glance in the worst case scenario.

In order to calculate this metric, we firstly have to select the best colours in the texture patch to compare. For this, we look for the dominant colours on a given patch using K-means cluster analysis. By using this method, we produce a distribution of the most 5 dominant colours as illustrated in Figure \ref{fig:distribution}. We then test the most dominant colours against the most dominant colours of the other texture.
...
\subcaptionbox{Two 80 x 80 pixel texture patches from different 3D models\label{fig:textures}\linebreak}
 ...
 \caption{Texture patches used for evaluation quality of colour fidelity across different 3D models resulting from the image-based 3D modelling process} 
 \label{fig:texturepatches} 
\end{figure} 


Table presents a comparison across the five most dominant colours. To calculate this, we take the top 5 most dominant colours of a texture patch and convert  them to the CIELAB color space. We then apply the CIELAB 2000 $\Delta$E algorithm using Python colormath library. 



Our results demonstrate that the change in visual perception between the most dominant colours of the two texture patches fall within the values of 10. This means our process produces low resolution textures which have a good and uniform quality in terms of colour. This allows us to produce a standardised process which can be deployed for the large-scale content, while ensuring the visual quality of the outcomes.
