...
For this, the research \MSedit[investigates the use of creative and narrative-based
approaches, given the potential for stories to illuminate]{deploys creative and narrative or story-based approaches as means to illuminate}investigates the use of creative and narrative-based
approaches, given the potential for stories to illuminate  different viewpoints
and interpretations of Cultural Heritage within the community. \MS{Here the two fold contribution is not clear and the word contribution is mentioned twice}
...
Reality (AR) Maps}, \MS{These are physical maps with augmented digital narratives, delivered through \emph{Immersive Web} technology} which are physical maps with augmented digital narratives
and delivered through \emph{Immersive Web} technology. This \MS{The} concept is
...
their communities. The approach \MS{was initially piloted with a class of 32 children in a local primary school in Brighton and Hove (UK) in order to understand its suitability
for community engagement, especially for young audiences. Currently, the project has been expanded to five more schools in the area} has been tested with 32 children in local
...
demonstrates the potential \MS{of the synergy between creative and digital approaches} of both creative and digital approaches for
...
benefit from these technologies to understanding how communities can \MS{meaningfully engage in CH processes while identifying artefacts they can connect with in various ways}
...
\MS{For instance, until now} Until now, communities have rarely had an input into which heritage to preserve.
