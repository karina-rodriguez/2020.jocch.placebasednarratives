...
\captionsetup{textfont=it,labelfont=bf,aboveskip=1.5ex}
\captionsetup[sub]{labelfont=rm,size=normalsize,skip=3pt}

% For backwards compatibility to old LaTeX type font selection. Uncomment if
% your document adheres to LaTeX2e recommendations. \let\rm=\rmfamily   
% \let\sf=\sffamily    \let\tt=\ttfamily \let\it=\itshape     \let\sl=\slshape
%     \let\sc=\scshape \let\bf=\bfseries

% end of prologue
% --------------------------------------------------------------------- EG
% author guidelines plus sample file for EG publication using LaTeX2e input
...
% % if the Editors-in-Chief have given you the data, you may uncomment % the
% following five lines and insert it here % % \volume{36}   % the volume in
% which the issue will be published; % \issue{1}     % the issue number of the
% publication % \pStartPage{1}      % set starting page
...
\teaser{ 
\centering
\includegraphics[width=0.495\linewidth]{images-hi-res/mapalone.png}
\includegraphics[width=0.43\linewidth]{images-hi-res/screenshoot.png}

  \caption{Artwork and Augmented Reality (AR) Map
with embedded creative narratives of the communities' cultural environment 
for dissemination to a wider audience} \label{fig:teaser} }
...
\includegraphics[width=0.8\linewidth]{images-hi-res/method.png}
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/variousassets.jpg}
...
% \includegraphics[width=\linewidth]{images-hi-res/IMG_7377.jpeg} % %     
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/maprender.jpg}
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/boxes.png} \caption{Example
...
high quality results.
 ...
 \begin{figure}[ht] \centering
\includegraphics[width=0.49\linewidth]{images-hi-res/za_tex_template.png}
\includegraphics[width=0.49\linewidth]{images-hi-res/za_tex.jpg}
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/models.PNG} \caption{3D model
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/lkp1.jpg}
\includegraphics[width=\linewidth]{images-hi-res/mgp2.jpg}
\includegraphics[width=\linewidth]{images-hi-res/fhp1.jpg} 
\caption{Drawings
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/ARcontentw_sculpture.png}
\includegraphics[width=\linewidth]{images-hi-res/animationARexperience_zoom.png}
...
\begin{figure}[ht] \centering
\includegraphics[width=\linewidth]{images-hi-res/IMG_20190720_103105.jpg}
\includegraphics[width=\linewidth]{images-hi-res/IMG_20190720_151644.jpg}
...
\includegraphics[width=0.49\linewidth]{images-hi-res/side.png}
\includegraphics[width=0.49\linewidth]{images-hi-res/side1_cropped.png}
