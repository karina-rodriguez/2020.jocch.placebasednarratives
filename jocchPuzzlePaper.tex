...
Geometry Algorithms Library (CGAL) as its constructive solid geometry
...
\section{Deployment and Observations}
\label{eva}
...
The detailed evaluation of the puzzle pot activity and its performance
