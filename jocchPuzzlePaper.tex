...
\begin{table}
  \begin{tabular}{|l|p{0.933\linewidth}|}
    ...
    $R$ & Random jitter of polygon vertices along that great circle, as multiple of edge length.\\
    $A$ & Amplitude (as multiple of edge length) by which that polygon is tangentially displaced away from the great circle.\\
    % formally niter:
    $n$ & Number of levels of recursion in bisecting polygon edges.\\
    % formally decay:
