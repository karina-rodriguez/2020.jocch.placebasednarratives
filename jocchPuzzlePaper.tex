...
\begin{figure}[htb]
  ...
  \includegraphics[width=0.45\linewidth]{images/uk}
    \includegraphics[width=0.45\linewidth]{images/france}
...
this, the 3D model is firstly fitted at the centre of the fractured
sphere (see Figure~\ref{fig:sphere}). Thereafter, as shown in
Figure~\ref{fig:intersection}-a, each section of the fractured sphere
...
produced as shown in Figure~\ref{fig:intersection}-b.
%
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\linewidth]{images/sphere}
  \includegraphics[width=0.45\linewidth]{images/sphere1}
  \caption{\label{fig:sphere}
    3D model of the reconstructed urn positioned at the centre of the fractured sphere}
\end{figure}
%
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\linewidth]{images/intersection}
  \includegraphics[width=0.45\linewidth]{images/puzzlepiece}
  \caption{\label{fig:intersection}
    a) Intersection of 3D model of reconstructed urn and section of the fractured sphere; b) resulting puzzle piece}
\end{figure}
...
The algorithm produces an intersection between the cylinder and a
simplified version of the puzzle piece for speed purposes. It then
...
in Figure~\ref{fig:holes}-a.

These generated geometries are then used to generate the
blind-holes. This is achieved by using the difference operation
between the 3D puzzle piece and the generated geometry (see
Figure~\ref{fig:holes}-a) and b). The same process is repeated for all
the puzzle pieces. This step produces all puzzle pieces with the
required holes (see Figure~\ref{fig:teaser}-c).
%
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\linewidth]{images/holes1.jpg}
      \includegraphics[width=0.32\linewidth]{images/holes2.jpg}
      \includegraphics[width=0.32\linewidth]{images/holes3.jpg}
      
  \caption{\label{fig:holes}%
    a) Puzzle piece with cylinder for blind-holes;
    b) puzzle piece with geometry generated for the creation of each blind-hole;
