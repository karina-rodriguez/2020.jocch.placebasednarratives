...
\begin{figure}[htb]
  ...
  \caption{\label{manyexamples}%
    Examples of puzzles produced for the the Saltdean pot scan
    with a fracture pattern generated with settings $m$: 6, $n$: 6,
    $R$: 0.3, $A$: 0.1, $\rho$: 0.5, $\sigma$: 0. \TWedit{The
      results represent conscutive runs of the algorithm
      for twelve randomly chosen random seeds. The bottom row
      shows [@KARINA: WHAT DOES IT SHOW?].}}
\end{figure}
