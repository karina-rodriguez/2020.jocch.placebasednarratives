...
Figure~\ref{fig:sphereb}, \MSedit[each section of the fractured sphere is intersected with the 3D model of the artefact]{for each fragment, the 3D model of the artefact is intersected with a spherical sector spanned by the fragment outline}.\TWedit[ The
